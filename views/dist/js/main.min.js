...
Array.prototype.fill=function(e){var a=this.length;if(e>a)for(var r=e-1-a;r>=0;r--)this[r+1]=this[r%1];return this};
// This iterates through background sliding pizzas and changes the value of translateX for each pizza.
for(var e=document.getElementsByClassName("mover"),a=[0,1,2,3,4],r=([a.fill(a.length+e.length-1)],document.body.scrollTop/1250),n=0,i=0;n<e.length,i<a.length;n++,i++){var t=Math.sin(r+i),o=-e[n].basicLeft+1e3*t+"px";e[n].style.transform="translateX("+o+") translateZ(0)"}if(
...
function r(e){switch(e){case"1":return 25;case"2":return 33.33;case"3":return 50;default:console.log("bug in sizeSwitcher")}}
// Iterates through pizza elements on the page and changes their widths
function n(){for(var e=document.getElementsByClassName("randomPizzaContainer"),a=0;a<e.length;a++)e[a].style.width=i+"%"}window.performance.mark("mark_start_resize"),a(e);var i=r(e);n(e),
