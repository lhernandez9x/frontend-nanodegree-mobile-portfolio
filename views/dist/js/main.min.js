...
function r(e){switch(e){case"1":return 25;case"2":return 33;case"3":return 50;default:console.log("bug in sizeSwitcher")}}
// Iterates through pizza elements on the page and changes their widths
function n(){for(var e=document.getElementsByClassName("randomPizzaContainer"),a=0;a<e.length;a++)
//var dx = determineDx(randPizzaCont[i], size);
//var newwidth = (randPizzaCont[i].scrollWidth + dx) + 'px';
e[a].style.width=i+"%"}window.performance.mark("mark_start_resize"),a(e);var i=r(e);n(e),
// User Timing API is awesome
window.performance.mark("mark_end_resize"),window.performance.measure("measure_pizza_resize","mark_start_resize","mark_end_resize");var t=window.performance.getEntriesByName("measure_pizza_resize");console.log("Time to resize pizzas: "+t[t.length-1].duration+"ms")};window.performance.mark("mark_start_generating");// collect timing data
