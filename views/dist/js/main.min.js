...
var frame=0,items=document.getElementsByClassName("mover");
// runs updatePositions on scroll
window.addEventListener("scroll",updatePositions),
// Generates the sliding pizzas when the page loads.
document.addEventListener("DOMContentLoaded",function(){for(var e=Math.floor(window.innerWidth/200),a=Math.floor(window.innerHeight/200),r=250,n=e*a,i=0;n>i;i++){var t=document.createElement("img");t.className="mover",t.src="dist/images/pizza.png",t.style.height="100px",t.style.width="73.333px",t.basicLeft=i%e*r,t.style.top=Math.floor(i/e)*r+"px",document.getElementById("movingPizzas1").appendChild(t)}updatePositions()});