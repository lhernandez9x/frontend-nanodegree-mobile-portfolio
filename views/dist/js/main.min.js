...
function updatePositions(){frame++,window.performance.mark("mark_start_frame");for(var e=document.querySelectorAll(".mover"),a=0;a<e.length;a++){var r=Math.sin(document.body.scrollTop/1250+a%5);e[a].style.left=e[a].basicLeft+100*r+"px"}if(
...
function n(e){for(var a=0;a<document.querySelectorAll(".randomPizzaContainer").length;a++){var n=r(document.querySelectorAll(".randomPizzaContainer")[a],e),i=document.querySelectorAll(".randomPizzaContainer")[a].offsetWidth+n+"px";document.querySelectorAll(".randomPizzaContainer")[a].style.width=i}}window.performance.mark("mark_start_resize"),a(e),n(e),
...
document.addEventListener("DOMContentLoaded",function(){for(var e=8,a=256,r=0;200>r;r++){var n=document.createElement("img");n.className="mover",n.src="dist/images/pizza.png",n.style.height="100px",n.style.width="73.333px",n.basicLeft=r%e*a,n.style.top=Math.floor(r/e)*a+"px",document.querySelector("#movingPizzas1").appendChild(n)}updatePositions()});