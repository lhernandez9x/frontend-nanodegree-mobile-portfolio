...
function logAverageFrame(e){for(var a=e.length,r=0,n=a-1;n>a-11;n--)r+=e[n].duration;console.log("Average time to generate last 10 frames: "+r/10+"ms")}
...
function a(e){switch(e){case"1":return void(document.getElementById("pizzaSize").innerHTML="Small");case"2":return void(document.getElementById("pizzaSize").innerHTML="Medium");case"3":return void(document.getElementById("pizzaSize").innerHTML="Large");default:console.log("bug in changeSliderLabel")}}
// Returns the size difference to change a pizza element from one size to another. Called by changePizzaSlices(size).
function r(e,a){
// Optional TODO: change to 3 sizes? no more xl?
// Changes the slider value to a percent width
function r(e){switch(e){case"1":return.25;case"2":return.3333;case"3":return.5;default:console.log("bug in sizeSwitcher")}}var n=e.offsetWidth,i=document.getElementById("randomPizzas").offsetWidth,t=n/i,o=r(a),s=(o-t)*i;return s}
...
document.addEventListener("DOMContentLoaded",function(){for(var e=Math.floor(window.innerWidth/200),a=Math.floor(window.innerHeight/230),r=256,n=e*a,i=0;n>i;i++){var t=document.createElement("img");t.className="mover",t.src="dist/images/pizza-sm.png",t.style.height="100px",t.style.width="73.333px",t.basicLeft=i%e*r,t.style.top=Math.floor(i/e)*r+"px",document.getElementById("movingPizzas1").appendChild(t)}updatePositions()});